...
const VendorForm = () => {
  ...
  const { mutateAsync, isSuccess } = useMutation({
    mutationFn: (vendorCreate: Vendor) => createVendor(vendorCreate),
    onSuccess: () => {
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.logoText}>
          Create <Text style={{ color: Colors.dark.borderDark }}>Vendors</Text>
        </Text>
      </View>
      ...
      <View style={styles.form}>
        ...
        <TouchableOpacity style={dirtyFields.name! ? styles.button : styles.button_disabled}
          onPress={handleSubmit(onSubmit)} disabled={!dirtyFields.name}>
